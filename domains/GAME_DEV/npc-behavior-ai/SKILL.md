...
Create autonomous agent logic using state machines or behavior trees.
...
### Basic Usage
'Use npc-behavior-ai to analyze my current project context.'

### Advanced Usage
'Run npc-behavior-ai with focus on high-priority optimization targets.'
