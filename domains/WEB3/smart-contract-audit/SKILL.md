...
Perform security analysis and audit for solidity-based decentralized logic.
...
### Basic Usage
'Use smart-contract-audit to analyze my current project context.'

### Advanced Usage
'Run smart-contract-audit with focus on high-priority optimization targets.'
