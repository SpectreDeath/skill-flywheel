...
Optimize AI agent performance and efficiency.

## Purpose

Improve agent response times, accuracy, and resource utilization.

## Capabilities

1. **Performance Analysis**: Analyze agent performance metrics
2. **Resource Optimization**: Optimize resource usage and allocation
3. **Response Time Improvement**: Reduce agent response times
4. **Accuracy Enhancement**: Improve agent decision accuracy

## Usage Examples

### Basic Usage

"Execute agent performance optimization workflow"

### Advanced Usage

"Run agent performance optimization with custom configuration and validation"

## Input Format

```yaml
agent_performance_optimization_request:
  parameters: object
...
```yaml
agent_performance_optimization_result:
  success: boolean
  artifacts: array
  metrics: object
