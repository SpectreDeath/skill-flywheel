...
Design architectures for multi-agent AI systems.

## Purpose

Create scalable and robust systems with multiple interacting AI agents.

## Capabilities

1. **Architecture Planning**: Design multi-agent system architecture
2. **Agent Specialization**: Define specialized roles for different agents
3. **System Integration**: Integrate agents into cohesive systems
4. **Scalability Design**: Design for system scalability

## Usage Examples

### Basic Usage

"Execute multi agent system design workflow"

### Advanced Usage

"Run multi agent system design with custom configuration and validation"

## Input Format

```yaml
multi_agent_system_design_request:
  parameters: object
...
```yaml
multi_agent_system_design_result:
  success: boolean
  artifacts: array
  metrics: object
