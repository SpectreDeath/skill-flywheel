...
Implement comprehensive security measures for cloud environments.

## Purpose

Ensure cloud infrastructure and applications meet security best practices and compliance requirements.

## Capabilities

1. **Security Assessment**: Evaluate current cloud security posture
2. **Policy Implementation**: Implement security policies and controls
3. **Monitoring Setup**: Configure security monitoring and alerting
4. **Compliance Validation**: Validate compliance with industry standards

## Usage Examples

### Basic Usage

"Execute cloud security hardening workflow"

### Advanced Usage

"Run cloud security hardening with custom configuration and validation"

## Input Format

```yaml
cloud_security_hardening_request:
  parameters: object
...
```yaml
cloud_security_hardening_result:
  success: boolean
  artifacts: array
  metrics: object
