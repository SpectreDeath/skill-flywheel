...
name: de-fi-protocol-integration
---
origin: manual
triggers:
  - agent
...
Connect and interact with decentralized finance liquidity pools and protocols.
...
### Basic Usage
'Use de-fi-protocol-integration to analyze my current project context.'

### Advanced Usage
'Run de-fi-protocol-integration with focus on high-priority optimization targets.'
