...
name: wallet-connection-workflow
---
...
Implement secure multi-wallet connection and signature handling.
...
### Basic Usage
'Use wallet-connection-workflow to analyze my current project context.'

### Advanced Usage
'Run wallet-connection-workflow with focus on high-priority optimization targets.'
