...
Implement and optimize the core real-time loop for interactive games.
...
### Basic Usage
'Use gameplay-loop-design to analyze my current project context.'

### Advanced Usage
'Run gameplay-loop-design with focus on high-priority optimization targets.'
