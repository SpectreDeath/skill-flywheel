...
name: physics-system-simulation
---
origin: manual
triggers:
  - agent
...
Configure and optimize real-time collisions and rigid body dynamics.
...
### Basic Usage
'Use physics-system-simulation to analyze my current project context.'

### Advanced Usage
'Run physics-system-simulation with focus on high-priority optimization targets.'
