...
name: intro-to-shap-iq
Source: AI-Tutorial-Codes-Included
Source_File: Intro_to_SHAP_IQ.ipynb
---
origin: manual
triggers:
  - agent
...
**Input**: A request to implement intro to shap iq from scratch.
...
- **Source**: `Intro_to_SHAP_IQ.ipynb` from the AI-Tutorial-Codes-Included library
