...
name: crewai-gemini-workflow
Source: AI-Tutorial-Codes-Included
Source_File: CrewAI_Gemini_Workflow_Marktechpost.ipynb
---
origin: manual
triggers:
  - agent
...
Teaches agents how to implement CrewAI Gemini Workflow patterns and techniques. Derived from a production-grade Jupyter Notebook tutorial covering real-world agentic workflows implementation strategies.

## Description

This skill encapsulates the knowledge and implementation patterns from the "CrewAI Gemini Workflow" tutorial. It provides a structured guide for building, configuring, and deploying agentic workflows solutions. The tutorial source covers end-to-end implementation with working code examples, making this skill immediately actionable for agent-driven development.
...
**Input**: A request to implement crewai gemini workflow from scratch.
...
- **Source**: `CrewAI_Gemini_Workflow_Marktechpost.ipynb` from the AI-Tutorial-Codes-Included library
