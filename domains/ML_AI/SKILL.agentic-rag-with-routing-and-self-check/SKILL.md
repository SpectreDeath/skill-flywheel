...
name: agentic-rag-with-routing-and-self-check
Source: AI-Tutorial-Codes-Included
Source_File: agentic_rag_with_routing_and_self_check_marktechpost.py
---

## Purpose

Teaches agents how to implement agentic rag with routing and self check patterns and techniques. Derived from a production-grade Python script tutorial covering real-world retrieval augmented generation implementation strategies.

## Description

This skill encapsulates the knowledge and implementation patterns from the "agentic rag with routing and self check" tutorial. It provides a structured guide for building, configuring, and deploying retrieval augmented generation solutions. The tutorial source covers end-to-end implementation with working code examples, making this skill immediately actionable for agent-driven development.
...
**Input**: A request to implement agentic rag with routing and self check from scratch.
...
- **Source**: `agentic_rag_with_routing_and_self_check_marktechpost.py` from the AI-Tutorial-Codes-Included library
