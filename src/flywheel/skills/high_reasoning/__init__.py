...
from .quantum_cognition_simulator import register_skill as register_quantum_cognition_simulator
from .data_driven_relational_intelligence import register_skill as register_data_driven_relational_intelligence
from .logical_data_fusion import register_skill as register_logical_data_fusion
from .neural_symbolic_reasoning_engine import register_skill as register_neural_symbolic_reasoning_engine
from .computational_creativity_engine import register_skill as register_computational_creativity_engine
from .strategic_decision_support import register_skill as register_strategic_decision_support
