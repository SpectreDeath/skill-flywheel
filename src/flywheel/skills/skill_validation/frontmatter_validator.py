...
SKILL_NAME = "frontmatter-validator"
DOMAIN = "skill_validation"
DESCRIPTION = "## Description"
...
def get_capabilities():
    ...
    return {
        ...
        "domain": DOMAIN,
        "description": DESCRIPTION,
        "actions": ["execution_depth", "verbose", "description_validates_yaml_frontmatter_i", "purpose_to_be_provided_dynamically_durin", "input_format", "output_format", "examples_to_be_provided_dynamically_duri", "implementation_notes_to_be_provided_dyna", "capabilities", "usage_examples"],
    }
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "execution_depth":
        ...
        return {"result": result, "metadata": {"action": action, "timestamp": timestamp}}
    elif action == "description_validates_yaml_frontmatter_i":
        result = {"action": "description_validates_yaml_frontmatter_i", "status": "executed", "description": "Description  Validates YAML frontmatter in SKILL"}
        return {"result": result, "metadata": {"action": action, "timestamp": timestamp}}
