"""
Tutorial Skill: web3-blockchain-development
...
The Web3 Blockchain Development skill provides an automated workflow to address comprehensive blockchain development workflows and best practices for web3 applications, smart contracts, and decentrali
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "The Web3 Blockchain Development skill provides an automated workflow to address comprehensive blockchain development workflows and best practices for web3 applications, smart contracts, and decentrali",
            "category": "Development",
