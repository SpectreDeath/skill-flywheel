"""
Tutorial Skill: game-dev-multiplayer
...
The Game Dev Multiplayer skill provides an automated workflow to address networked game development and multiplayer architecture for professional online game projects.. It is designed to be highly mod
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "The Game Dev Multiplayer skill provides an automated workflow to address networked game development and multiplayer architecture for professional online game projects.. It is designed to be highly mod",
            "category": "Development",
