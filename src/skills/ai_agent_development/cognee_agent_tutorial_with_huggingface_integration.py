"""
Tutorial Skill: cognee-agent-tutorial-with-huggingface-integration
...
This skill encapsulates the knowledge and implementation patterns from the \"Cognee Agent Tutorial with HuggingFace Integration\" tutorial. It provides a structured guide for building, configuring, an
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Cognee Agent Tutorial with HuggingFace Integration\" tutorial. It provides a structured guide for building, configuring, an",
            "category": "AI Agents",
