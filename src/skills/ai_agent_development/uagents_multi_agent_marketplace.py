"""
Tutorial Skill: uagents-multi-agent-marketplace
...
This skill encapsulates the knowledge and implementation patterns from the \"uagents multi agent marketplace\" tutorial. It provides a structured guide for building, configuring, and deploying multi-a
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"uagents multi agent marketplace\" tutorial. It provides a structured guide for building, configuring, and deploying multi-a",
            "category": "Multi-Agent Systems",
