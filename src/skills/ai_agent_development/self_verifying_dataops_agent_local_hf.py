"""
Tutorial Skill: self-verifying-dataops-agent-local-hf
...
This skill encapsulates the knowledge and implementation patterns from the \"self verifying dataops agent local hf\" tutorial. It provides a structured guide for building, configuring, and deploying a
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"self verifying dataops agent local hf\" tutorial. It provides a structured guide for building, configuring, and deploying a",
            "category": "AI Agents",
