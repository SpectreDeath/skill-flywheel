"""
Tutorial Skill: how-to-build-an-advanced-end-to-end-voice-ai-agent-using-hugging-face-pipelines
...
This skill encapsulates the knowledge and implementation patterns from the \"how to build an advanced end to end voice ai agent using hugging face pipelines\" tutorial. It provides a structured guide 
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"how to build an advanced end to end voice ai agent using hugging face pipelines\" tutorial. It provides a structured guide ",
            "category": "AI Agents",
