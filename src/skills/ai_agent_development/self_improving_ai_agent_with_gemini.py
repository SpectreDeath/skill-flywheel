"""
Tutorial Skill: self-improving-ai-agent-with-gemini
...
This skill encapsulates the knowledge and implementation patterns from the \"Self Improving AI Agent with Gemini\" tutorial. It provides a structured guide for building, configuring, and deploying ai 
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Self Improving AI Agent with Gemini\" tutorial. It provides a structured guide for building, configuring, and deploying ai ",
            "category": "AI Agents",
