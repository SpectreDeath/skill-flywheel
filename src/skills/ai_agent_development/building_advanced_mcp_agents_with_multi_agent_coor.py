"""
Tutorial Skill: building-advanced-mcp-agents-with-multi-agent-coordination
...
This skill encapsulates the knowledge and implementation patterns from the \"Building Advanced MCP Agents with Multi Agent Coordination\" tutorial. It provides a structured guide for building, configu
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Building Advanced MCP Agents with Multi Agent Coordination\" tutorial. It provides a structured guide for building, configu",
            "category": "Multi-Agent Systems",
