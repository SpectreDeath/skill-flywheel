"""
Tutorial Skill: autogen-teamtool-roundrobin
...
This skill encapsulates the knowledge and implementation patterns from the \"AutoGen TeamTool RoundRobin\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engin
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"AutoGen TeamTool RoundRobin\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engin",
            "category": "AI/ML Engineering",
