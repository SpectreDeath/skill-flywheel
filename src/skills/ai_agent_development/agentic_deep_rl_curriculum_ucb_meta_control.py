"""
Tutorial Skill: agentic-deep-rl-curriculum-ucb-meta-control
...
This skill encapsulates the knowledge and implementation patterns from the \"agentic deep rl curriculum ucb meta control\" tutorial. It provides a structured guide for building, configuring, and deplo
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"agentic deep rl curriculum ucb meta control\" tutorial. It provides a structured guide for building, configuring, and deplo",
            "category": "AI Agents",
