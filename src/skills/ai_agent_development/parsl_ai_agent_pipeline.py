"""
Tutorial Skill: parsl-ai-agent-pipeline
...
This skill encapsulates the knowledge and implementation patterns from the \"parsl ai agent pipeline\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents solut
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"parsl ai agent pipeline\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents solut",
            "category": "AI Agents",
