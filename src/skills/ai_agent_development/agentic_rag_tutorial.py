"""
Tutorial Skill: agentic-rag-tutorial
...
This skill encapsulates the knowledge and implementation patterns from the \"agentic rag tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying retrieval augmente
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"agentic rag tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying retrieval augmente",
            "category": "Retrieval Augmented Generation",
