"""
Tutorial Skill: langchain-deepagents
...
This skill encapsulates the knowledge and implementation patterns from the \"Langchain Deepagents\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents solution
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Langchain Deepagents\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents solution",
            "category": "AI Agents",
