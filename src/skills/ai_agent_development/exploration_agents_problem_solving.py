"""
Tutorial Skill: exploration-agents-problem-solving
...
This skill encapsulates the knowledge and implementation patterns from the \"Exploration Agents Problem Solving\" tutorial. It provides a structured guide for building, configuring, and deploying ai a
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Exploration Agents Problem Solving\" tutorial. It provides a structured guide for building, configuring, and deploying ai a",
            "category": "AI Agents",
