"""
Tutorial Skill: how-to-enable-function-calling-in-mistral-agents
...
This skill encapsulates the knowledge and implementation patterns from the \"how to enable function calling in Mistral Agents\" tutorial. It provides a structured guide for building, configuring, and 
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"how to enable function calling in Mistral Agents\" tutorial. It provides a structured guide for building, configuring, and ",
            "category": "AI Agents",
