"""
Tutorial Skill: agent2agent-collaboration
...
This skill encapsulates the knowledge and implementation patterns from the \"agent2agent collaboration\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents sol
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"agent2agent collaboration\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents sol",
            "category": "AI Agents",
