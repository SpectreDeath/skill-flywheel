"""
Tutorial Skill: graph-agent-framework-with-gemini
...
This skill encapsulates the knowledge and implementation patterns from the \"graph agent framework with gemini\" tutorial. It provides a structured guide for building, configuring, and deploying ai ag
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"graph agent framework with gemini\" tutorial. It provides a structured guide for building, configuring, and deploying ai ag",
            "category": "AI Agents",
