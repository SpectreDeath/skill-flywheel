"""
Tutorial Skill: mle-agent-ollama-local-pipeline
...
This skill encapsulates the knowledge and implementation patterns from the \"mle agent ollama local pipeline\" tutorial. It provides a structured guide for building, configuring, and deploying ai agen
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"mle agent ollama local pipeline\" tutorial. It provides a structured guide for building, configuring, and deploying ai agen",
            "category": "AI Agents",
