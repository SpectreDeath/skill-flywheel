"""
Tutorial Skill: gemini-autogen-multiagent-framework
...
This skill encapsulates the knowledge and implementation patterns from the \"gemini autogen multiagent framework\" tutorial. It provides a structured guide for building, configuring, and deploying mul
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"gemini autogen multiagent framework\" tutorial. It provides a structured guide for building, configuring, and deploying mul",
            "category": "Multi-Agent Systems",
