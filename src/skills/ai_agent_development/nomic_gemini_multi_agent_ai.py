"""
Tutorial Skill: nomic-gemini-multi-agent-ai
...
This skill encapsulates the knowledge and implementation patterns from the \"nomic gemini multi agent ai\" tutorial. It provides a structured guide for building, configuring, and deploying multi-agent
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"nomic gemini multi agent ai\" tutorial. It provides a structured guide for building, configuring, and deploying multi-agent",
            "category": "Multi-Agent Systems",
