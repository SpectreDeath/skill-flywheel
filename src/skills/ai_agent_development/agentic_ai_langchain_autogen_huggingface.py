"""
Tutorial Skill: agentic-ai-langchain-autogen-huggingface
...
This skill encapsulates the knowledge and implementation patterns from the \"Agentic AI LangChain AutoGen HuggingFace\" tutorial. It provides a structured guide for building, configuring, and deployin
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Agentic AI LangChain AutoGen HuggingFace\" tutorial. It provides a structured guide for building, configuring, and deployin",
            "category": "AI Agents",
