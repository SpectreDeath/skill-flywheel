"""
Tutorial Skill: smolagents-advanced-multi-agent-orchestration
...
This skill encapsulates the knowledge and implementation patterns from the \"smolagents advanced multi agent orchestration\" tutorial. It provides a structured guide for building, configuring, and dep
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"smolagents advanced multi agent orchestration\" tutorial. It provides a structured guide for building, configuring, and dep",
            "category": "Multi-Agent Systems",
