"""
Tutorial Skill: live-python-execution-and-validation-agent
...
This skill encapsulates the knowledge and implementation patterns from the \"Live Python Execution and Validation Agent\" tutorial. It provides a structured guide for building, configuring, and deploy
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Live Python Execution and Validation Agent\" tutorial. It provides a structured guide for building, configuring, and deploy",
            "category": "AI Agents",
