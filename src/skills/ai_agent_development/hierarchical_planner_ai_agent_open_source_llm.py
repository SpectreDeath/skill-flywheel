"""
Tutorial Skill: hierarchical-planner-ai-agent-open-source-llm
...
This skill encapsulates the knowledge and implementation patterns from the \"hierarchical planner ai agent open source llm\" tutorial. It provides a structured guide for building, configuring, and dep
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"hierarchical planner ai agent open source llm\" tutorial. It provides a structured guide for building, configuring, and dep",
            "category": "AI Agents",
