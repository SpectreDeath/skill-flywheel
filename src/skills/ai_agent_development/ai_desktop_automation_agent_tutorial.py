"""
Tutorial Skill: ai-desktop-automation-agent-tutorial
...
This skill encapsulates the knowledge and implementation patterns from the \"ai desktop automation agent tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying ai
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"ai desktop automation agent tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying ai",
            "category": "AI Agents",
