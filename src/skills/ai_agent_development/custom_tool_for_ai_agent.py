"""
Tutorial Skill: custom-tool-for-ai-agent
...
This skill encapsulates the knowledge and implementation patterns from the \"Custom Tool For AI Agent\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents solu
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Custom Tool For AI Agent\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents solu",
            "category": "AI Agents",
