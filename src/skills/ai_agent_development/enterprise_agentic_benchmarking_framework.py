"""
Tutorial Skill: enterprise-agentic-benchmarking-framework
...
This skill encapsulates the knowledge and implementation patterns from the \"enterprise agentic benchmarking framework\" tutorial. It provides a structured guide for building, configuring, and deployi
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"enterprise agentic benchmarking framework\" tutorial. It provides a structured guide for building, configuring, and deployi",
            "category": "AI Agents",
