...
This skill encapsulates the knowledge and implementation patterns from the \"emi agent\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents solutions. The tuto
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"emi agent\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents solutions. The tuto",
            "category": "AI Agents",
