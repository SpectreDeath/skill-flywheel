"""
Tutorial Skill: inflation-agent
...
This skill encapsulates the knowledge and implementation patterns from the \"inflation agent\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents solutions. Th
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"inflation agent\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents solutions. Th",
            "category": "AI Agents",
