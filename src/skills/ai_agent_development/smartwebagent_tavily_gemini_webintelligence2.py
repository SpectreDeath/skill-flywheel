"""
Tutorial Skill: smartwebagent-tavily-gemini-webintelligence2
...
This skill encapsulates the knowledge and implementation patterns from the \"smartwebagent tavily gemini webintelligence2\" tutorial. It provides a structured guide for building, configuring, and depl
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"smartwebagent tavily gemini webintelligence2\" tutorial. It provides a structured guide for building, configuring, and depl",
            "category": "AI Agents",
