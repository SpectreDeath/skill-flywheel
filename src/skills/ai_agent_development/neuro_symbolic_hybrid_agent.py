"""
Tutorial Skill: neuro-symbolic-hybrid-agent
...
This skill encapsulates the knowledge and implementation patterns from the \"neuro symbolic hybrid agent\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents s
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"neuro symbolic hybrid agent\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents s",
            "category": "AI Agents",
