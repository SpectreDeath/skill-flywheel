"""
Tutorial Skill: context-folding-llm-agent-long-horizon
...
This skill encapsulates the knowledge and implementation patterns from the \"context folding llm agent long horizon\" tutorial. It provides a structured guide for building, configuring, and deploying 
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"context folding llm agent long horizon\" tutorial. It provides a structured guide for building, configuring, and deploying ",
            "category": "AI Agents",
