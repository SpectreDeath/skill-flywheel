"""
Tutorial Skill: customizable-multitool-ai-agent-with-claude
...
This skill encapsulates the knowledge and implementation patterns from the \"Customizable MultiTool AI Agent with Claude\" tutorial. It provides a structured guide for building, configuring, and deplo
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Customizable MultiTool AI Agent with Claude\" tutorial. It provides a structured guide for building, configuring, and deplo",
            "category": "Multi-Agent Systems",
