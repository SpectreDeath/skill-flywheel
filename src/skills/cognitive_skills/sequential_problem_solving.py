"""
Tutorial Skill: sequential-problem-solving
...
Sequential problem-solving is a methodical approach that breaks down problem resolution into discrete, ordered steps. Each step builds on the previous, with verification before proceeding. This reduce
...
Generated: 2026-03-21T07:13:48.771293
"""
import logging
import time
import datetime
...
SKILL_ID = "6d7416fb-4d40-4dce-aadf-b44abd0b4cde"
SKILL_NAME = "sequential-problem-solving"
DOMAIN = "COGNITIVE_SKILLS"
VERSION = "1.0.0"
COMPLEXITY = "Medium"
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "Sequential problem-solving is a methodical approach that breaks down problem resolution into discrete, ordered steps. Each step builds on the previous, with verification before proceeding. This reduce",
            "category": "Thinking Skills",
