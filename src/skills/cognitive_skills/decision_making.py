"""
Tutorial Skill: decision-making
...
Decision-making involves defining the decision, identifying alternatives, establishing weighted criteria, evaluating options, and selecting the best solution. It provides a structured framework for ma
...
Generated: 2026-03-21T07:13:48.875415
"""
import logging
import time
import datetime
...
SKILL_ID = "62ee89e2-06c1-47dc-be05-70f5582a4e23"
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "Decision-making involves defining the decision, identifying alternatives, establishing weighted criteria, evaluating options, and selecting the best solution. It provides a structured framework for ma",
            "category": "Thinking Skills",
