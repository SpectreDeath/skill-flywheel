"""
Tutorial Skill: federated-lora-llm-finetuning-flower
...
This skill encapsulates the knowledge and implementation patterns from the \"federated lora llm finetuning flower\" tutorial. It provides a structured guide for building, configuring, and deploying fe
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"federated lora llm finetuning flower\" tutorial. It provides a structured guide for building, configuring, and deploying fe",
            "category": "Federated Learning",
