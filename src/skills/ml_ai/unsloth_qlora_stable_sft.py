"""
Tutorial Skill: unsloth-qlora-stable-sft
...
This skill encapsulates the knowledge and implementation patterns from the \"unsloth qlora stable sft\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineer
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"unsloth qlora stable sft\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineer",
            "category": "AI/ML Engineering",
