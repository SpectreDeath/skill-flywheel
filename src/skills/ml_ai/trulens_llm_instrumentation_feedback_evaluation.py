"""
Tutorial Skill: trulens-llm-instrumentation-feedback-evaluation
...
This skill encapsulates the knowledge and implementation patterns from the \"trulens llm instrumentation feedback evaluation\" tutorial. It provides a structured guide for building, configuring, and d
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"trulens llm instrumentation feedback evaluation\" tutorial. It provides a structured guide for building, configuring, and d",
            "category": "Large Language Models",
