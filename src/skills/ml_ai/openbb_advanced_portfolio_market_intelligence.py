"""
Tutorial Skill: openbb-advanced-portfolio-market-intelligence
...
This skill encapsulates the knowledge and implementation patterns from the \"openbb advanced portfolio market intelligence\" tutorial. It provides a structured guide for building, configuring, and dep
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"openbb advanced portfolio market intelligence\" tutorial. It provides a structured guide for building, configuring, and dep",
            "category": "AI/ML Engineering",
