"""
Tutorial Skill: advanced-pykeen-knowledge-graph-embeddings
...
This skill encapsulates the knowledge and implementation patterns from the \"advanced pykeen knowledge graph embeddings\" tutorial. It provides a structured guide for building, configuring, and deploy
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"advanced pykeen knowledge graph embeddings\" tutorial. It provides a structured guide for building, configuring, and deploy",
            "category": "AI/ML Engineering",
