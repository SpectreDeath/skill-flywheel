"""
Tutorial Skill: intro-to-shap-iq
...
This skill encapsulates the knowledge and implementation patterns from the \"Intro to SHAP IQ\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering solu
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Intro to SHAP IQ\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering solu",
            "category": "AI/ML Engineering",
