"""
Tutorial Skill: chain-of-thought
...
This skill encapsulates the knowledge and implementation patterns from the \"Chain of Thought\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering solu
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Chain of Thought\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering solu",
            "category": "AI/ML Engineering",
