"""
Tutorial Skill: meta-hydra-advanced-implementation
...
This skill encapsulates the knowledge and implementation patterns from the \"meta hydra advanced implementation\" tutorial. It provides a structured guide for building, configuring, and deploying ai/m
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"meta hydra advanced implementation\" tutorial. It provides a structured guide for building, configuring, and deploying ai/m",
            "category": "AI/ML Engineering",
