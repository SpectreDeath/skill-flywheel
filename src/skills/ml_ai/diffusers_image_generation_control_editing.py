"""
Tutorial Skill: diffusers-image-generation-control-editing
...
This skill encapsulates the knowledge and implementation patterns from the \"diffusers image generation control editing\" tutorial. It provides a structured guide for building, configuring, and deploy
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"diffusers image generation control editing\" tutorial. It provides a structured guide for building, configuring, and deploy",
            "category": "Computer Vision",
