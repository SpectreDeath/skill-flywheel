"""
Tutorial Skill: advanced-pyspark-end-to-end-tutorial
...
This skill encapsulates the knowledge and implementation patterns from the \"Advanced PySpark End to End Tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying ai
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Advanced PySpark End to End Tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying ai",
            "category": "AI/ML Engineering",
