"""
Tutorial Skill: tinydev-gemini-implementation
...
This skill encapsulates the knowledge and implementation patterns from the \"tinydev gemini implementation\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml eng
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"tinydev gemini implementation\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml eng",
            "category": "AI/ML Engineering",
