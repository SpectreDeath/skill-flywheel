"""
Tutorial Skill: embodied-vla-latent-mpc-agent
...
This skill encapsulates the knowledge and implementation patterns from the \"embodied vla latent mpc agent\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"embodied vla latent mpc agent\" tutorial. It provides a structured guide for building, configuring, and deploying ai agents",
            "category": "AI Agents",
