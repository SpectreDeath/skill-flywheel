"""
Tutorial Skill: quantum-state-evolution-and-entanglement-qutip-tutorial
...
This skill encapsulates the knowledge and implementation patterns from the \"Quantum State Evolution and Entanglement QuTiP Tutorial\" tutorial. It provides a structured guide for building, configurin
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Quantum State Evolution and Entanglement QuTiP Tutorial\" tutorial. It provides a structured guide for building, configurin",
            "category": "Quantum Computing",
