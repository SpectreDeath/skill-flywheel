"""
Tutorial Skill: advanced-ai-evaluator-enterprise-grade-framework
...
This skill encapsulates the knowledge and implementation patterns from the \"Advanced AI Evaluator Enterprise Grade Framework\" tutorial. It provides a structured guide for building, configuring, and 
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Advanced AI Evaluator Enterprise Grade Framework\" tutorial. It provides a structured guide for building, configuring, and ",
            "category": "AI/ML Engineering",
