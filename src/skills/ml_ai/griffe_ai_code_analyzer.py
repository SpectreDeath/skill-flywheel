"""
Tutorial Skill: griffe-ai-code-analyzer
...
This skill encapsulates the knowledge and implementation patterns from the \"griffe ai code analyzer\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineeri
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"griffe ai code analyzer\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineeri",
            "category": "AI/ML Engineering",
