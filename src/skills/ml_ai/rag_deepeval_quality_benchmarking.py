"""
Tutorial Skill: rag-deepeval-quality-benchmarking
...
This skill encapsulates the knowledge and implementation patterns from the \"rag deepeval quality benchmarking\" tutorial. It provides a structured guide for building, configuring, and deploying retri
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"rag deepeval quality benchmarking\" tutorial. It provides a structured guide for building, configuring, and deploying retri",
            "category": "Retrieval Augmented Generation",
