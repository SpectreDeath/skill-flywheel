"""
Tutorial Skill: voice-ai-whisperx-advanced-tutorial
...
This skill encapsulates the knowledge and implementation patterns from the \"voice ai whisperx advanced tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying voi
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"voice ai whisperx advanced tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying voi",
            "category": "Voice AI",
