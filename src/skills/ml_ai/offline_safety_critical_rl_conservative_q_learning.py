"""
Tutorial Skill: offline-safety-critical-rl-conservative-q-learning-d3rlpy
...
This skill encapsulates the knowledge and implementation patterns from the \"offline safety critical rl conservative q learning d3rlpy\" tutorial. It provides a structured guide for building, configur
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"offline safety critical rl conservative q learning d3rlpy\" tutorial. It provides a structured guide for building, configur",
            "category": "Reinforcement Learning",
