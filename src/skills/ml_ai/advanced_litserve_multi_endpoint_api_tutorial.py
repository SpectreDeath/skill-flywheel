"""
Tutorial Skill: advanced-litserve-multi-endpoint-api-tutorial
...
This skill encapsulates the knowledge and implementation patterns from the \"advanced litserve multi endpoint api tutorial\" tutorial. It provides a structured guide for building, configuring, and dep
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"advanced litserve multi endpoint api tutorial\" tutorial. It provides a structured guide for building, configuring, and dep",
            "category": "AI/ML Engineering",
