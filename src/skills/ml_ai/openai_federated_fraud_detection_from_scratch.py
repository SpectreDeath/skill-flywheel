"""
Tutorial Skill: openai-federated-fraud-detection-from-scratch
...
This skill encapsulates the knowledge and implementation patterns from the \"openai federated fraud detection from scratch\" tutorial. It provides a structured guide for building, configuring, and dep
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"openai federated fraud detection from scratch\" tutorial. It provides a structured guide for building, configuring, and dep",
            "category": "Federated Learning",
