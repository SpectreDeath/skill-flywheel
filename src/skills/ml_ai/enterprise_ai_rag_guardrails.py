"""
Tutorial Skill: enterprise-ai-rag-guardrails
...
This skill encapsulates the knowledge and implementation patterns from the \"enterprise ai rag guardrails\" tutorial. It provides a structured guide for building, configuring, and deploying retrieval 
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"enterprise ai rag guardrails\" tutorial. It provides a structured guide for building, configuring, and deploying retrieval ",
            "category": "Retrieval Augmented Generation",
