"""
Tutorial Skill: enhanced-brightdata-gemini-scraper-tutorial
...
This skill encapsulates the knowledge and implementation patterns from the \"Enhanced BrightData Gemini Scraper Tutorial\" tutorial. It provides a structured guide for building, configuring, and deplo
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Enhanced BrightData Gemini Scraper Tutorial\" tutorial. It provides a structured guide for building, configuring, and deplo",
            "category": "Data Engineering",
