"""
Tutorial Skill: advanced-jax-flax-optax-training-pipeline
...
This skill encapsulates the knowledge and implementation patterns from the \"advanced jax flax optax training pipeline\" tutorial. It provides a structured guide for building, configuring, and deployi
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"advanced jax flax optax training pipeline\" tutorial. It provides a structured guide for building, configuring, and deployi",
            "category": "AI/ML Engineering",
