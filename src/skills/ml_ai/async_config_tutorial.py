"""
Tutorial Skill: async-config-tutorial
...
This skill encapsulates the knowledge and implementation patterns from the \"async config tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"async config tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering",
            "category": "AI/ML Engineering",
