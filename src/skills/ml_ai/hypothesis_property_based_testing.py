"""
Tutorial Skill: hypothesis-property-based-testing
...
This skill encapsulates the knowledge and implementation patterns from the \"hypothesis property based testing\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"hypothesis property based testing\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml",
            "category": "AI/ML Engineering",
