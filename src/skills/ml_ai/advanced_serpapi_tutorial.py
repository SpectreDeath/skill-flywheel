"""
Tutorial Skill: advanced-serpapi-tutorial
...
This skill encapsulates the knowledge and implementation patterns from the \"advanced serpapi tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml enginee
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"advanced serpapi tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml enginee",
            "category": "AI/ML Engineering",
