"""
Tutorial Skill: multi-agent-demo
...
This skill encapsulates the knowledge and implementation patterns from the \"multi agent demo\" tutorial. It provides a structured guide for building, configuring, and deploying multi-agent systems so
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"multi agent demo\" tutorial. It provides a structured guide for building, configuring, and deploying multi-agent systems so",
            "category": "Multi-Agent Systems",
