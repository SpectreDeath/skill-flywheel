"""
Tutorial Skill: huggingface-trackio-advanced-tutorial
...
This skill encapsulates the knowledge and implementation patterns from the \"huggingface trackio advanced tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying a
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"huggingface trackio advanced tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying a",
            "category": "AI/ML Engineering",
