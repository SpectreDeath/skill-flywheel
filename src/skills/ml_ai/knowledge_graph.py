"""
Tutorial Skill: knowledge-graph
...
This skill encapsulates the knowledge and implementation patterns from the \"Knowledge Graph\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering solut
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Knowledge Graph\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering solut",
            "category": "AI/ML Engineering",
