"""
Tutorial Skill: pipecat-huggingface-implementation
...
This skill encapsulates the knowledge and implementation patterns from the \"pipecat huggingface implementation\" tutorial. It provides a structured guide for building, configuring, and deploying ai/m
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"pipecat huggingface implementation\" tutorial. It provides a structured guide for building, configuring, and deploying ai/m",
            "category": "AI/ML Engineering",
