...
This skill encapsulates the knowledge and implementation patterns from the \"LLM Parameters\" tutorial. It provides a structured guide for building, configuring, and deploying large language models so
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"LLM Parameters\" tutorial. It provides a structured guide for building, configuring, and deploying large language models so",
            "category": "Large Language Models",
