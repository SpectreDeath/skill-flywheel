"""
Tutorial Skill: custom-gpt-local-colab-chat
...
This skill encapsulates the knowledge and implementation patterns from the \"custom gpt local colab chat\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engin
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"custom gpt local colab chat\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engin",
            "category": "AI/ML Engineering",
