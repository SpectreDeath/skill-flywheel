"""
Tutorial Skill: dpo-alignment-qlora-ultrafeedback
...
This skill encapsulates the knowledge and implementation patterns from the \"dpo alignment qlora ultrafeedback\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"dpo alignment qlora ultrafeedback\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml",
            "category": "AI/ML Engineering",
