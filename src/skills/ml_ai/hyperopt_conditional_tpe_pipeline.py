"""
Tutorial Skill: hyperopt-conditional-tpe-pipeline
...
This skill encapsulates the knowledge and implementation patterns from the \"hyperopt conditional tpe pipeline\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"hyperopt conditional tpe pipeline\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml",
            "category": "AI/ML Engineering",
