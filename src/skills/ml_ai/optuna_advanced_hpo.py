"""
Tutorial Skill: optuna-advanced-hpo
...
This skill encapsulates the knowledge and implementation patterns from the \"optuna advanced hpo\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering s
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"optuna advanced hpo\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering s",
            "category": "AI/ML Engineering",
