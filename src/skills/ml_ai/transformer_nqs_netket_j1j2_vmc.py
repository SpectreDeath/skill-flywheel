"""
Tutorial Skill: transformer-nqs-netket-j1j2-vmc
...
This skill encapsulates the knowledge and implementation patterns from the \"transformer nqs netket j1j2 vmc\" tutorial. It provides a structured guide for building, configuring, and deploying deep le
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"transformer nqs netket j1j2 vmc\" tutorial. It provides a structured guide for building, configuring, and deploying deep le",
            "category": "Deep Learning",
