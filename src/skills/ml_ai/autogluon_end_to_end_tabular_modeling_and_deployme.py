"""
Tutorial Skill: autogluon-end-to-end-tabular-modeling-and-deployment
...
This skill encapsulates the knowledge and implementation patterns from the \"autogluon end to end tabular modeling and deployment\" tutorial. It provides a structured guide for building, configuring, 
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"autogluon end to end tabular modeling and deployment\" tutorial. It provides a structured guide for building, configuring, ",
            "category": "AI/ML Engineering",
