...
This skill encapsulates the knowledge and implementation patterns from the \"MLFlow Intro\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering solution
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"MLFlow Intro\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering solution",
            "category": "AI/ML Engineering",
