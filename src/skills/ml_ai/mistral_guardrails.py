"""
Tutorial Skill: mistral-guardrails
...
This skill encapsulates the knowledge and implementation patterns from the \"Mistral Guardrails\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering so
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Mistral Guardrails\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering so",
            "category": "AI/ML Engineering",
