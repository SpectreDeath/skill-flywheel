"""
Tutorial Skill: jina-langchain-gemini-ai-assistant
...
This skill encapsulates the knowledge and implementation patterns from the \"Jina LangChain Gemini AI Assistant\" tutorial. It provides a structured guide for building, configuring, and deploying ai/m
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Jina LangChain Gemini AI Assistant\" tutorial. It provides a structured guide for building, configuring, and deploying ai/m",
            "category": "AI/ML Engineering",
