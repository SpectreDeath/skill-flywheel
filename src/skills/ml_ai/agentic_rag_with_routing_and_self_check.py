"""
Tutorial Skill: agentic-rag-with-routing-and-self-check
...
This skill encapsulates the knowledge and implementation patterns from the \"agentic rag with routing and self check\" tutorial. It provides a structured guide for building, configuring, and deploying
...
Generated: 2026-03-20T19:17:27.940123
"""
import logging
import time
import datetime
...
SKILL_ID = "390c308a-368a-440c-8b10-f7ad07f3e071"
SKILL_NAME = "agentic-rag-with-routing-and-self-check"
DOMAIN = "ML_AI"
VERSION = "1.0.0"
COMPLEXITY = "Medium"
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"agentic rag with routing and self check\" tutorial. It provides a structured guide for building, configuring, and deploying",
            "category": "Retrieval Augmented Generation",
