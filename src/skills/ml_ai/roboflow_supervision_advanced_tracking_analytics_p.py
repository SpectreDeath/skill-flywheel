"""
Tutorial Skill: roboflow-supervision-advanced-tracking-analytics-pipeline
...
This skill encapsulates the knowledge and implementation patterns from the \"roboflow supervision advanced tracking analytics pipeline\" tutorial. It provides a structured guide for building, configur
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"roboflow supervision advanced tracking analytics pipeline\" tutorial. It provides a structured guide for building, configur",
            "category": "Computer Vision",
