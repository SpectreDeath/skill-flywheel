"""
Tutorial Skill: semantic-highlighting
...
This skill encapsulates the knowledge and implementation patterns from the \"Semantic Highlighting\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"Semantic Highlighting\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engineering",
            "category": "AI/ML Engineering",
