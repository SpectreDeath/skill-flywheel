"""
Tutorial Skill: zarr-implementation-tutorial
...
This skill encapsulates the knowledge and implementation patterns from the \"zarr implementation tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engi
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"zarr implementation tutorial\" tutorial. It provides a structured guide for building, configuring, and deploying ai/ml engi",
            "category": "AI/ML Engineering",
