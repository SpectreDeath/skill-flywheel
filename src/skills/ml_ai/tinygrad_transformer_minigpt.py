"""
Tutorial Skill: tinygrad-transformer-minigpt
...
This skill encapsulates the knowledge and implementation patterns from the \"tinygrad transformer minigpt\" tutorial. It provides a structured guide for building, configuring, and deploying deep learn
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"tinygrad transformer minigpt\" tutorial. It provides a structured guide for building, configuring, and deploying deep learn",
            "category": "Deep Learning",
