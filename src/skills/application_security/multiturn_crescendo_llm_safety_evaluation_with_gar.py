"""
Tutorial Skill: multiturn-crescendo-llm-safety-evaluation-with-garak
...
This skill encapsulates the knowledge and implementation patterns from the \"multiturn crescendo llm safety evaluation with garak\" tutorial. It provides a structured guide for building, configuring, 
...
Generated: 2026-03-22T13:47:48.246604
"""
import logging
import time
import datetime
...
SKILL_ID = "59aaeea0-ca2c-4674-8f7c-7381ac36ad4d"
SKILL_NAME = "multiturn-crescendo-llm-safety-evaluation-with-garak"
DOMAIN = "APPLICATION_SECURITY"
VERSION = "1.0.0"
COMPLEXITY = "High"
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"multiturn crescendo llm safety evaluation with garak\" tutorial. It provides a structured guide for building, configuring, ",
            "category": "Large Language Models",
