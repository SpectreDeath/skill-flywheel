"""
Tutorial Skill: robust-llm-safety-filters-adaptive-attack-defense
...
This skill encapsulates the knowledge and implementation patterns from the \"robust llm safety filters adaptive attack defense\" tutorial. It provides a structured guide for building, configuring, and
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"robust llm safety filters adaptive attack defense\" tutorial. It provides a structured guide for building, configuring, and",
            "category": "AI Security",
