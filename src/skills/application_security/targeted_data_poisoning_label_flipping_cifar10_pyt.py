"""
Tutorial Skill: targeted-data-poisoning-label-flipping-cifar10-pytorch
...
This skill encapsulates the knowledge and implementation patterns from the \"targeted data poisoning label flipping cifar10 pytorch\" tutorial. It provides a structured guide for building, configuring
...
async def invoke(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if action == "describe":
        result = {
            ...
            "description": "This skill encapsulates the knowledge and implementation patterns from the \"targeted data poisoning label flipping cifar10 pytorch\" tutorial. It provides a structured guide for building, configuring",
            "category": "Data Engineering",
